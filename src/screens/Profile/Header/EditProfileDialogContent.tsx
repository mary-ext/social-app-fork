...
/**
 * renders the profile editor and reports unsaved changes to its dialog.
 *
 * @param props profile, dialog handles, and dirty-state callback
 * @returns the profile editing form
 */
