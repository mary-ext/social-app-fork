		...
		>
			<Header.Outer noBottomBorder>
				...
				<Header.Content align="left">
					{moderationOpts ? (
						<ProfileCard.Name profile={profile} moderationOpts={moderationOpts} textStyle={[a.font_bold]} />
					) : (
						<ProfileCard.NamePlaceholder />
					)}
					<Header.SubtitleText>{sanitizeHandle(profile.handle, '@')}</Header.SubtitleText>
				</Header.Content>
