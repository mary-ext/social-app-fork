...
type Props = NativeStackScreenProps<AllNavigatorParams, 'ActivityNotificationSettings'>;
					...
					<SettingsList.Container>
						<SettingsList.Item style={[a.align_start]}>
							...
							<ItemTextWithSubtitle
								...
								subtitleText={<Trans>Get notified about posts and replies from accounts you choose.</Trans>}
							/>
						</SettingsList.Item>
						{isError ? (
							...
							<PreferenceControls name="subscribedPost" preference={preferences?.subscribedPost} />
						)}
					</SettingsList.Container>
				}
				data={items}
										...
										<Admonition.Content>
											<Admonition.Text>
												<Trans>
													...
													<RNText style={[a.font_semi_bold, t.atoms.text_contrast_high]}>bell icon</RNText>{' '}
													<BellRingingFilledIcon size="xs" style={t.atoms.text_contrast_high} />.
												</Trans>
											</Admonition.Text>
											<Admonition.Text>
												<Trans>
													If you want to restrict who can receive notifications for your account's activity,
			...
			<ProfileCard.Outer>
				<ProfileCard.Header>
					...
					<View style={[a.flex_1, a.gap_2xs]}>
						<ProfileCard.NameAndHandle profile={profile} moderationOpts={moderationOpts} inline />
						<Text style={[a.leading_snug, t.atoms.text_contrast_medium]}>{preview}</Text>
					</View>
					<Button
						label={l`Edit notifications from ${createSanitizedDisplayName(profile)}`}
						size="small"
						color="primary"
						variant="solid"
