...
type Props = NativeStackScreenProps<AllNavigatorParams, 'LikesOnRepostsNotificationSettings'>;
				...
				<SettingsList.Container>
					<SettingsList.Item style={[a.align_start]}>
						...
						<ItemTextWithSubtitle
							...
							subtitleText={<Trans>Get notifications when people like posts that you've reposted.</Trans>}
						/>
					</SettingsList.Item>
					{isError ? (
						...
						<PreferenceControls name="likeViaRepost" preference={preferences?.likeViaRepost} />
					)}
				</SettingsList.Container>
			</Layout.Content>
		</Layout.Screen>
