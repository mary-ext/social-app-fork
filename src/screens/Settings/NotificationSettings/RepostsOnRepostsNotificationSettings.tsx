...
type Props = NativeStackScreenProps<AllNavigatorParams, 'RepostsOnRepostsNotificationSettings'>;
				...
				<SettingsList.Container>
					<SettingsList.Item style={[a.align_start]}>
						...
						<ItemTextWithSubtitle
							...
							subtitleText={<Trans>Get notifications when people repost posts that you've reposted.</Trans>}
						/>
					</SettingsList.Item>
					{isError ? (
						...
						<PreferenceControls name="repostViaRepost" preference={preferences?.repostViaRepost} />
					)}
				</SettingsList.Container>
			</Layout.Content>
		</Layout.Screen>
