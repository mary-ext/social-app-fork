...
function GroupChatItem({
	...
	return (
		<BaseChatItem
			convo={convo}
			avatar={<AvatarBubbles profiles={convo.members} size={isWithinSplitView ? 48 : 52} />}
			title={chatName}
...
function BaseChatItem({
	...
	const { lastMessage, LastMessageIcon, lastMessageSentAt, latestReportableMessage } = useMemo(() => {
