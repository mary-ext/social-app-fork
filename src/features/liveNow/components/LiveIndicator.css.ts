...
// wins over `Text`'s layered `size` variant, letting `Text` derive the device-snapped line-height — including
// the off-grid 7px tiny size that has no font-size token.
