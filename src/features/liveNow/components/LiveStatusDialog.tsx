...
import { type AppBskyActorDefs, type AppBskyEmbedExternal, moderateStatus } from '@atproto/api';
			...
			>
				<View style={[a.w_full, a.justify_center, a.gap_2xs]}>
					...
					<View style={[a.flex_row, a.align_center, a.gap_2xs]}>
						<Globe_Stroke2_Corner0_Rounded size="xs" style={[t.atoms.text_contrast_medium]} />
