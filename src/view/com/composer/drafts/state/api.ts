...
/** Convert server DraftView to DraftSummary for list display. Also checks which media files exist locally. */
export function draftViewToSummary({ view }: { view: AppBskyDraftDefs.DraftView }): DraftSummary {
	const meta = {
