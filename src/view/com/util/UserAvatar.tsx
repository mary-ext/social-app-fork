		...
		<>
			<Menu.Root>
				...
				<Menu.Outer showCancel>
					<Menu.Group>
						<Menu.Item testID="changeAvatarLibraryBtn" label={l`Upload from Library`} onPress={onOpenLibrary}>
					...
					{!!avatar && (
						<>
							<Menu.Divider />
							<Menu.Group>
								<Menu.Item testID="changeAvatarRemoveBtn" label={l`Remove Avatar`} onPress={onRemoveAvatar}>
									<Menu.ItemText>
