...
export const convertLegacyToastType = (type: ToastType | LegacyToastType): ToastType => {
	switch (type) {
		// these ones are fine
		case 'default':
		case 'success':
...
export function show(message: string, type: ToastType | LegacyToastType = 'default'): void {
