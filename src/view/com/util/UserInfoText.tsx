...
export function UserInfoText({
	...
	if (isError) {
		...
		return (
			<InlineLinkText label={text} style={style} numberOfLines={1} to={makeProfileLink(profile)}>
	...
	return <LoadingPlaceholder width={80} height={8} style={[a.relative, { top: 1, left: 2 }]} />;
}
