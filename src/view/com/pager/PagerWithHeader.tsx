...
export interface PagerWithHeaderProps {
	...
	renderHeader?: ({ setMinimumHeight }: { setMinimumHeight: () => void }) => JSX.Element;
	initialPage?: number;
	onPageSelected?: (index: number) => void;
	onCurrentPageSelected?: (index: number) => void;
	allowHeaderOverScroll?: boolean;
}
export const PagerWithHeader = forwardRef<PagerRef, PagerWithHeaderProps>(function PageWithHeaderImpl(
	{
		children,
		testID,
		items,
