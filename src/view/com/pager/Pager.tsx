import { Children, type JSX, useCallback, useImperativeHandle, useRef, useState } from 'react';
...
interface Props {
	...
	onPageScrollStateChanged?: (state: 'dragging' | 'idle' | 'settling') => void;
}
	...
	return (
		<View style={s.hContentRegion}>
			...
			{Children.map(children, (child, i) => (
				<View style={selectedPage === i ? a.flex_1 : a.hidden} key={`page-${i}`}>
					{child}
				</View>
			))}
		</View>
