			...
			<moderationOptsOverrideContext.Provider value={modOpts}>
				<ScrollView>
					<CenteredView style={[t.atoms.bg, a.px_lg, a.py_lg]}>
						<H1 style={[a.text_5xl, a.font_semi_bold, a.pb_lg]}>Moderation states</H1>
						...
						{scenario[0] === 'label' && (
							<>
								<View
									style={[a.border, a.rounded_sm, a.mt_lg, a.mb_lg, a.p_lg, t.atoms.border_contrast_medium]}
								>
								...
								<View style={[a.flex_row, a.flex_wrap, a.gap_md]}>
									<View>
										<Text style={[a.font_semi_bold, a.text_xs, t.atoms.text, a.pl_md, a.pb_xs]}>Target</Text>
										<View
											style={[
												a.border,
												a.rounded_full,
										...
										>
											<Toggle.Group label="Target" type="radio" values={target} onChange={setTarget}>
												<View style={[a.flex_row, a.gap_md, a.flex_wrap]}>
...
function CustomLabelForm({
	...
	return (
		<View style={[a.flex_row, a.flex_wrap, a.gap_md, t.atoms.bg_contrast_25, a.rounded_md, a.p_md, a.mt_md]}>
			<View>
				<Text style={[a.font_semi_bold, a.text_xs, t.atoms.text, a.pl_md, a.pb_xs]}>Blurs</Text>
				<View
					style={[a.border, a.rounded_full, a.px_md, a.py_sm, t.atoms.border_contrast_medium, t.atoms.bg]}
				>
					<Toggle.Group
						label="Blurs"
						type="radio"
			...
			<View>
				<Text style={[a.font_semi_bold, a.text_xs, t.atoms.text, a.pl_md, a.pb_xs]}>Severity</Text>
				<View
					style={[a.border, a.rounded_full, a.px_md, a.py_sm, t.atoms.border_contrast_medium, t.atoms.bg]}
				>
					<Toggle.Group
