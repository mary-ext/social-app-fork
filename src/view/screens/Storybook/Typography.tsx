...
export function Typography() {
	return (
		<View style={[a.gap_md]}>
			...
			<Text style={[a.text_xl, a.font_medium, a.italic]}>This is medium italic text</Text>
			<Text style={[a.text_xl, a.font_semi_bold]}>This is bold text</Text>
			<Text style={[a.text_xl, a.font_semi_bold, a.italic]}>This is bold italic text</Text>
			<Text style={[a.text_xl, a.font_bold]}>This is heavy text</Text>
			<Text style={[a.text_xl, a.font_bold, a.italic]}>This is heavy italic text</Text>
