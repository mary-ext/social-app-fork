	...
	return (
		<View style={[a.gap_md]}>
			...
			<View style={[a.flex_row, a.gap_xl]}>
				...
				<Globe size="2xl" fill={colors.text} />
			</View>
			<View style={[a.flex_row, a.gap_xl]}>
				...
				<ArrowTopRight size="2xl" fill={colors.text} />
			</View>
			<View style={[a.flex_row, a.gap_xl]}>
				...
				<CalendarDays size="2xl" fill={colors.text} />
			</View>
			<View style={[a.flex_row, a.gap_xl]}>
				...
				<Loader size="2xl" fill={colors.text} />
			</View>
			<View style={[a.flex_row, a.gap_xl]}>
