 ...
 * `PixelRatio.roundToNearestPixel` and avoiding fractional CSS pixels, whose edges land between device pixels
 * and snap inconsistently (dropped hairlines, shifted alignment).
 */
