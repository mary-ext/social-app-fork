...
import { type SharedValue, useSharedValue, withSpring } from '#/lib/animations/reanimatedCompat';
...
export function useMinimalShellMode() {
	...
	if (!context) throw new Error('useMinimalShellMode must be used within a MinimalModeProvider');
	return context;
}
