...
const stateContext = createContext<StateContext>(persisted.defaults.requireAltTextEnabled);
stateContext.displayName = 'AltTextRequiredStateContext';
const setContext = createContext<SetContext>((_: persisted.Schema['requireAltTextEnabled']) => {});
