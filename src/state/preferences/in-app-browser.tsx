...
const stateContext = createContext<StateContext>(persisted.defaults.useInAppBrowser);
stateContext.displayName = 'InAppBrowserStateContext';
const setContext = createContext<SetContext>((_: persisted.Schema['useInAppBrowser']) => {});
