...
export async function manipulateAsync(uri: string, actions: Action[] = [], options: ManipulateOptions = {}) {
	...
	const mimeType = options.format === SaveFormat.PNG ? 'image/png' : 'image/jpeg';
