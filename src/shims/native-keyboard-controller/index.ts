...
function omitKeyboardScrollProps(
...
export const KeyboardChatScrollView = forwardRef<
  ScrollView,
  KeyboardAwareScrollViewProps
...
export const KeyboardGestureArea = forwardRef<View, KeyboardGestureAreaProps>(
  function KeyboardGestureArea(
...
export const KeyboardStickyView = forwardRef<View, KeyboardStickyViewProps>(
  function KeyboardStickyView({enabled, offset, ...props}, ref) {
    void enabled
    void offset
    return createElement(View, {...props, ref})
  },
