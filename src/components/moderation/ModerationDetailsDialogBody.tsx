...
/**
 * explains a moderation cause and offers an appeal when eligible.
 *
 * @param props moderation cause and dialog handle
 * @returns the cause details or appeal form
 */
export function ModerationDetailsDialogBody({ handle, modcause }: ModerationDetailsDialogProps) {
