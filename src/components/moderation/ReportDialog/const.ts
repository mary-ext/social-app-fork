...
export const NEW_TO_OLD_REASONS_MAP: Record<OzoneReportDefs.ReasonType, RootReportDefs.ReasonType> = {
	...
	[OzoneReportDefs.REASONVIOLENCEGRAPHICCONTENT]: RootReportDefs.REASONVIOLATION,
	[OzoneReportDefs.REASONVIOLENCEGLORIFICATION]: RootReportDefs.REASONVIOLATION,
	[OzoneReportDefs.REASONVIOLENCEEXTREMISTCONTENT]: RootReportDefs.REASONVIOLATION,
	...
	[OzoneReportDefs.REASONMISLEADINGIMPERSONATION]: RootReportDefs.REASONMISLEADING,
...
export const BSKY_LABELER_ONLY_REPORT_REASONS: Set<OzoneReportDefs.ReasonType> = new Set([
