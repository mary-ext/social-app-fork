...
/**
 * lists labels on the viewer's account or content and offers appeals for eligible labels.
 *
 * @param props labels, subject type, and dialog handle
 * @returns the label list or appeal form
 */
export function LabelsOnMeDialogBody({ handle, labels, type }: LabelsOnMeDialogProps) {
