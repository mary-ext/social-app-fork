...
export const IS_GLASS_AVAILABLE = isLiquidGlassAvailable() && isGlassEffectAPIAvailable();
...
function InnerGlassView({ fallbackStyle: _fallbackStyle, ...props }: GlassViewProps) {
	const t = useTheme();
