...
export function Icon() {
	...
	return <IconComponent fill={fill} size="lg" />;
}
...
export function Content({
	...
	return (
		<View style={[a.gap_sm, a.flex_1, { minHeight: 20 }, a.justify_center, style]} {...rest}>
			{children}
		</View>
	);
}
...
export function Row({ children, style }: { children: React.ReactNode; style?: StyleProp<ViewStyle> }) {
	return <View style={[a.w_full, a.flex_row, a.align_start, a.gap_sm, style]}>{children}</View>;
}
