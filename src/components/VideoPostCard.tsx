								...
								<View style={[a.relative, a.z_10, a.p_md, a.flex_row, a.gap_md]}>
									{likeCount > 0 && (
										<View style={[a.flex_row, a.align_center, a.gap_xs]}>
											...
											<Text style={[a.text_sm, a.font_semi_bold, { color: 'white' }]}>
...
export function VideoPostCardTextPlaceholder({ author }: { author?: AppBskyActorDefs.ProfileViewBasic }) {
	const t = useTheme();
					...
					>
						...
						<View style={[a.absolute, a.inset_0, t.atoms.shadow_sm]}>
							<View style={[a.absolute, a.inset_0, a.p_sm, { bottom: 'auto' }]}>
								<View style={[a.relative, a.rounded_full, { width: 24, height: 24 }]}>
									<UserAvatar type="user" size={24} avatar={post.author.avatar} />
									<MediaInsetBorder />
								</View>
							</View>
