...
function GroupChatJoinDialogInner({ control, code }: { control: Dialog.DialogControlProps; code?: string }) {
	const { t: l } = useLingui();

	return (
		<Dialog.ScrollableInner label={l`Join group chat`} style={{ maxWidth: 400, borderRadius: 36 }}>
			<View style={[a.gap_2xl, a.align_center]}>
				<GroupChatJoinDialogContent control={control} code={code} />
			</View>
			<Dialog.Close />
...
function GroupChatJoinDialogContent({
	...
	if (error) {
		return (
			<>
				<ChainLinkBrokenIcon fill={colors.primary_500} size="3xl" />
			...
			<>
				<View style={[a.py_lg, a.align_center]}>
					<View style={[a.gap_sm, a.align_center, a.mt_lg]}>
						<WarningIcon size="3xl" fill={colors.textContrastHigh} />
				...
				<View style={[a.w_full, a.gap_sm, a.align_center, a.mt_lg]}>
					...
					<View style={[a.flex_row, a.align_center]}>
						...
						<View style={[a.flex_row, a.ml_md]}>
							<PersonGroupIcon size="xs" fill={colors.text} className={css.personGroupIcon} />
						</View>
						<Text style={[a.text_center, a.text_xs, a.leading_snug]}>
								...
								>
									{createSanitizedDisplayName(
										...
										getDisplayRestrictions(
											moderateProfile(joinLinkPreview.owner, moderationOpts),
