 ...
 *
 * Our app supports some languages that are not included in date-fns by default, in which case it will fall
 * back to English.
 *
...
/** Returns a localized `formatDistance` function. {@link formatDistance} */
