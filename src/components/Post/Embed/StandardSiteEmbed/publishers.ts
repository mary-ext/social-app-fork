...
export function getStandardSitePublisherHost(view: AppBskyEmbedExternal.ViewExternal): string | null {
...
export function matchStandardSitePublisherByUri(uri: string | undefined): StandardSitePublisher | null {
