...
export function JoinRequestEmbed({
	...
	return <JoinRequestEmbedInner preview={preview} style={style} onOpen={onOpen} />;
}
	...
	return (
		...
		>
			<View style={[a.flex_row, a.gap_md, a.align_center]}>
				...
				<View style={[a.flex_1]}>
					<Text emoji style={[a.text_lg, a.font_bold, a.leading_tight, t.atoms.text]} numberOfLines={1}>
						{preview.name}
					</Text>
					<View style={[a.flex_row, a.align_center, a.gap_sm, a.mt_2xs, a.mb_sm]}>
						<Text
							style={[a.text_xs, a.leading_tight, a.font_medium, t.atoms.text_contrast_high]}
							allowFontScaling
							numberOfLines={1}
						>
					...
					<View style={[a.flex_row, a.align_center, a.gap_xs]}>
						<Text
							emoji
							style={[a.flex_shrink, a.text_sm, a.font_medium, a.leading_tight, t.atoms.text]}
							allowFontScaling
							numberOfLines={1}
						>
							<Trans comment="The group chat creator, in the format 'By {displayName}'.">
								By <Text style={[a.font_medium, t.atoms.text]}>{ownerDisplayName}</Text>
							</Trans>
						</Text>
						<ProfileBadges profile={preview.owner} size="sm" />
						<Text
							style={[a.flex_shrink, a.text_sm, a.font_medium, a.leading_tight, t.atoms.text_contrast_medium]}
							allowFontScaling
							numberOfLines={1}
						>
							{ownerHandle}
			...
			{convoId ? (
				...
				<Button
					...
					label={preview.requireApproval ? l`Request access to group chat` : l`Join group chat`}
					accessibilityHint={
			...
			<GroupChatJoinDialog control={joinDialogControl} code={preview.code} />
		</View>
	);
}
