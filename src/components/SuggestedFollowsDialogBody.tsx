...
/**
 * shows suggested accounts with interest filters and search.
 *
 * @param props dialog handle
 * @returns the suggested-follows list
 */
export function SuggestedFollowsDialogBody({ handle }: { handle: Dialog.DialogHandle }) {
