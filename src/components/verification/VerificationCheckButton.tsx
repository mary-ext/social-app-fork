...
import { useFullVerificationState, type FullVerificationState } from '#/components/verification';
...
function Badge({
	...
	return (
		<>
			<Button
				label={state.profile.isViewer ? l`View your verifications` : l`View this user's verifications`}
				hitSlop={20}
				onPress={(evt) => {
					evt.preventDefault();
