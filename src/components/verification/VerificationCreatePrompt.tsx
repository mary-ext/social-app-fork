	...
	return (
		<Prompt.Outer control={control}>
			<View style={[a.flex_row, a.align_center, a.gap_sm, a.pb_sm]}>
				...
				<Prompt.TitleText style={[a.pb_0]}>{l`Verify this account?`}</Prompt.TitleText>
			</View>
			<Prompt.DescriptionText>{l`This action can be undone at any time.`}</Prompt.DescriptionText>
			{moderationOpts ? (
				<ProfileCard.Header>
			...
			<View style={[a.pt_xl]}>
				{profile.displayName ? (
					...
					<Admonition type="warning">
						<Trans>This user does not have a display name, and therefore cannot be verified.</Trans>
					</Admonition>
				)}
			</View>
			<Dialog.Close />
