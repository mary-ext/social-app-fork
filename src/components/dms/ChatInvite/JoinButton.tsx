...
/**
 * The join/open action button for a chat invite. Reads the derived action from `ChatInvite.Root` context.
 * Pass `onPress` to intercept (e.g. to close a surface before navigating); it runs before the default action.
