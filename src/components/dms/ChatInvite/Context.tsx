...
/**
 * The derived state of the join/open action for a chat invite, computed once in `Root` and consumed by
 * `JoinButton` (or any custom action UI).
 */
...
export type ChatInviteContextValue = {
	...
	/**
	 * Whether the invite is rendered inside a fixed-height container; when true, text inside disables font
	 * scaling so the card doesn't overflow.
	 */
