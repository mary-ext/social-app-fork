...
/**
 * Presentational preview of a chat invite: member avatars, group name, member count, and owner. Reads the
 * preview from `ChatInvite.Root` context. Renders nothing if there's no preview (use a fallback alongside it
 * for that case).
 */
