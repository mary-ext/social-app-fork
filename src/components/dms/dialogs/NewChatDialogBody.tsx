 ...
 *
 * @param props dialog handle and new-chat callback
 * @returns the chat creation flow
 */
export function NewChatDialogBody({
	...
	return <ChatCreationFlow handle={handle} onChatReady={onNewChat} pickStep={SelectChatStep} />;
}
