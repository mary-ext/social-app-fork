...
export function ServerInputDialog({
	...
	const [fixedOption, setFixedOption] = useState<SegmentedControlOptions>(BSKY_SERVICE);
	...
	return (
		...
		>
			<View style={[a.relative, a.gap_md, a.w_full]}>
				...
				>
					<SegmentedControl.Item testID="bskyServiceSelectBtn" value={BSKY_SERVICE} label={l`Bluesky`}>
						<SegmentedControl.ItemText>{l`Bluesky`}</SegmentedControl.ItemText>
					</SegmentedControl.Item>
					<SegmentedControl.Item testID="customSelectBtn" value="custom" label={l`Custom`}>
