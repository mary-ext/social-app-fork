...
export function AutocompleteItemProfile({ active, isFirst, isLast, props, item }: AutocompleteItemProps) {
	...
	return (
		...
		>
			<ProfileCard.Header>
				<ProfileCard.Avatar disabledPreview profile={item.profile} moderationOpts={moderationOpts} />
				<ProfileCard.NameAndHandle profile={item.profile} moderationOpts={moderationOpts} />
			</ProfileCard.Header>
		</SiftItem>
	);
}
