 ...
 * 			<SegmentedControl.ItemText value="one">One</SegmentedControl.ItemText>
 * 		</SegmentedControl.Item>
 * 		<SegmentedControl.Item value="two">
 * 			<SegmentedControl.ItemText value="two">Two</SegmentedControl.ItemText>
 * 		</SegmentedControl.Item>
...
export function Root<T extends string>({
	...
	return (
		...
		>
			{selectedPosition !== null && <Slider x={selectedPosition.x} width={selectedPosition.width} />}
...
export function Item({
	...
	if (!ctx) throw new Error('SegmentedControl.Item must be used within a SegmentedControl.Root');
		...
		>
			...
			>
				{({ pressed, hovered, focused }) => (
					<InternalItemContext.Provider value={{ active, pressed, hovered, focused }}>
						{children}
...
export function ItemText({ style, ...props }: ButtonTextProps) {
	...
	if (!ctx) throw new Error('SegmentedControl.ItemText must be used within a SegmentedControl.Item');
	return (
		<ButtonText
			{...props}
			style={[
