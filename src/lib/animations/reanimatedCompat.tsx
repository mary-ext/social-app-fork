...
function createAnimatedComponent<Props extends object>(
  ...
  return forwardRef<unknown, Props & AnimatedCompatProps>(
...
export function useAnimatedRef<Value = AnimatedView>(
  _initial?: Value,
): AnimatedRef<Value> {
...
export function withDecay<Value>(
  _config: object,
  callback?: (finished?: boolean) => void,
): Value {
  callback?.(true)
