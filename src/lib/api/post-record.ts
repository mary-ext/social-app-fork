...
/**
 * Asserts a post view's `record` field — typed `unknown` on `@atcute`'s `PostView` — to the post
 * record type. The concrete type is always known from context wherever a `PostView` is in hand.
 *
